# <a name="intro"></a>**Sudoku Solver using Exact Satisfactability and Algorithm X**
...
> **Note**
> Although my approach uses two separate solvers, my main focus is on Algorithm X, which will be discussed in detail below.
